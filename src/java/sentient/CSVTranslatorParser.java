// Generated from CSVTranslator.g4 by ANTLR 4.7.2
package sentient;
...
public class CSVTranslatorParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "CSVTranslator.g4"; }
	...
	public ATN getATN() { return _ATN; }
	    ...
	    @SneakyThrows
	    public void translate(char sentiment, String tweetId, String tweet) {
	...
	public CSVTranslatorParser(TokenStream input) {
		super(input);
	...
	public final RowContext row() throws RecognitionException {
		...
		try {
			...
			((RowContext)_localctx).fields.add(((RowContext)_localctx).field);
			setState(21);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__0) {
			...
			match(T__2);
			    ...
			    String sentiment = ((RowContext)_localctx).fields.get(0).value;
			    String tweetId = ((RowContext)_localctx).fields.get(1).value;
			    String tweet = ((RowContext)_localctx).fields.get(5).value;
			    if ("\"0\"".equals(sentiment)) {
			        translate('0', tweetId, tweet);
			    }
			    else if ("\"4\"".equals(sentiment)) {
			        translate('1', tweetId, tweet);
			    }
	...
	public static class FieldContext extends ParserRuleContext {
		...
		public Token quoted;
		public TerminalNode TEXT() { return getToken(CSVTranslatorParser.TEXT, 0); }
		public TerminalNode STRING() { return getToken(CSVTranslatorParser.STRING, 0); }
	...
	public final FieldContext field() throws RecognitionException {
		...
		try {
			...
			case STRING:
				...
				((FieldContext)_localctx).value =  (((FieldContext)_localctx).quoted!=null?((FieldContext)_localctx).quoted.getText():null);
				}
				break;
			case T__0:
			case T__1:
	...
	public static final String _serializedATN =
		...
		"\2\2\2\b%\3\2\2\2\n\f\5\4\3\2\13\r\5\6\4\2\f\13\3\2\2\2\r\16\3\2\2\2\16"+
		"\f\3\2\2\2\16\17\3\2\2\2\17\3\3\2\2\2\20\21\5\6\4\2\21\5\3\2\2\2\22\27"+
		"\5\b\5\2\23\24\7\3\2\2\24\26\5\b\5\2\25\23\3\2\2\2\26\31\3\2\2\2\27\25"+
		"\3\2\2\2\27\30\3\2\2\2\30\33\3\2\2\2\31\27\3\2\2\2\32\34\7\4\2\2\33\32"+
		"\3\2\2\2\33\34\3\2\2\2\34\35\3\2\2\2\35\36\7\5\2\2\36\37\b\4\1\2\37\7"+
		"\3\2\2\2 !\7\6\2\2!&\b\5\1\2\"#\7\7\2\2#&\b\5\1\2$&\b\5\1\2% \3\2\2\2"+
		"%\"\3\2\2\2%$\3\2\2\2&\t\3\2\2\2\6\16\27\33%";
